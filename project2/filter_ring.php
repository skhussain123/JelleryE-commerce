...
{
	$query = "
		SELECT * FROM products WHERE Category='rings'
	";
...
<div class="col-lg-3 col-md-4 col-sm-6 pb-1">
                         <div class="product-item bg-light mb-4">
                             ...
                             <div class="text-center py-4">
                                 <p class=" text-decoration-none text-uppercase text-truncate" href=""><?php echo $row['Name'];?></p>
        ...
        ?> <h4 class='text-center'><?php echo 'Not Found Data';?></h4>
        <?php
    }
}
